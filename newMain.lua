...
local drawing  = loadstring(game:HttpGet('https://raw.githubusercontent.com/kanegroceryz/hi/main/drawing.lua'))()
local tween = loadstring(game:HttpGet('https://raw.githubusercontent.com/kanegroceryz/hi/main/custom_tween.lua'))()
